...
export const PRESS_CATEGORIES: PressCategory[] = [
  {
    ...
    priceMax: 380_000,
    samples: [
      "경상일보", "대학저널", "공감신문", "비즈월드", "뉴스컬처", "굿모닝경제",
      "테크월드", "메가경제", "세계비즈", "뉴스핌", "데이터넷", "이투뉴스",
      "마이데일리", "한경비즈니스", "파이낸셜뉴스", "이데일리", "전자신문",
      "헤럴드경제", "국민일보", "서울신문", "한국일보", "동아일보", "중앙일보",
      "경향신문", "조선비즈", "한국경제",
    ],
  },
  {
    ...
    priceMax: 380_000,
    samples: [
      "경상일보", "PPSS", "IT비즈뉴스", "잡포스트", "데이터넷", "이투뉴스",
      "스타데일리", "서울경제TV", "이로운넷", "국민일보", "한국경제TV",
      "데일리안", "한국일보",
    ],
  },
  {
    ...
    priceMax: 430_000,
    samples: [
      "한국목재신문", "내외경제TV", "세계비즈", "증권경제신문", "대한경제",
      "국토일보", "파이낸셜뉴스", "이데일리", "전자신문", "헤럴드경제",
      "한국경제TV", "조선비즈", "한국경제", "아시아경제", "땅집고", "동아일보",
      "경향신문",
    ],
  },
  {
  ...
  },
  {
    ...
    priceMax: 430_000,
    samples: [
      "메디컬투데이", "라포르시안", "메디칼트리뷴", "보건뉴스", "청년의사",
      "건강다이제스트", "중앙일보", "디지틀조선일보",
    ],
  },
  {
    key: "healthfood",
...
export const PRESS_OPTIONS: PressOption[] = [
  { name: "원고 대필", addKrw: 10_000, desc: "전문 작성자가 보도자료 원고를 대신 작성합니다." },
  { name: "이미지 제작", addKrw: 10_000, desc: "기사에 들어갈 대표 이미지를 제작합니다." },
  { name: "원고 대필 + 이미지 제작", addKrw: 15_000, desc: "원고와 이미지를 함께 제작합니다." },
];
...
export const PRESS_FAQS: PressFaq[] = [
  ...
  {
    q: "원고나 이미지가 없어도 되나요?",
    a: "원고 대필(+10,000원), 이미지 제작(+10,000원), 두 옵션 묶음(+15,000원)을 제공합니다.",
  },
  {
    q: "기사 수정·삭제가 가능한가요?",
