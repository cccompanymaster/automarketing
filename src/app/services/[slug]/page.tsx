...
import { getProduct, PRODUCT_SLUGS, type ProductSlug } from "@/lib/products";
...
function pricingHref(slug: ProductSlug): string {
    ...
    <>
      ...
      <main className="flex-1">
        ...
        <div className="mx-auto max-w-4xl px-5 py-14">
          ...
          {/* CTA — guests enter the funnel (/start); logged-in members go
              straight to the orderable price list (deep-linked to the matching
              group) so interest converts to an order without a detour. */}
