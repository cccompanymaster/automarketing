...
- `src/components/AuthProvider.tsx` — 클라이언트 인증 컨텍스트 (stub)
- 컴포넌트: `Landing`, `ServiceCard`, `SuccessStory`, `AuthEntry`, `Onboarding`, `LoginForm`, `SignupForm`, `LegalModal`, `SiteHeader`, `SiteFooter`, `KakaoButton`
